...
int xaccept(int socket, struct sockaddr *restrict address, socklen_t *restrict length);
size_t xwrite(int fd, const void *buf, size_t bytes);
size_t xread(int fd, const void *buf, size_t bytes);
int xclose(int fd);
